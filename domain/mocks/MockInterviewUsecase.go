...
func (_m *MockInterviewUsecase) GetByID(ctx context.Context, id string) (domain.MockInterview, error) {
...
func (_m *MockInterviewUsecase) Update(ctx context.Context, mi *domain.MockInterview) error {
...
func (_m *MockInterviewUsecase) Delete(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
